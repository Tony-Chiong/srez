...
def create_generator_loss(disc_output, gene_output, features):
    ...
    cross_entropy = tf.nn.sigmoid_cross_entropy_with_logits(labels=tf.ones_like(disc_output), logits=disc_output)
...
def create_discriminator_loss(disc_real_output, disc_fake_output):
    ...
    cross_entropy_fake = tf.nn.sigmoid_cross_entropy_with_logits(labels=tf.zeros_like(disc_fake_output), logits=disc_fake_output)
